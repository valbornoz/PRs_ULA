...
template <class C> int Archivo_Hash<C>::agregar(const C& dato)
{
...
template <class C> int Archivo_Hash<C>::eliminar(const C& dato)
{
  p.open(p_nombre.c_str(), ios::in | ios::out |ios::binary );
